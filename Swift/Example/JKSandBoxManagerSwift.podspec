#
# Be sure to run `pod lib lint JKSandBoxManagerSwift.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'Swift/JKSandBoxManagerSwift/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JKSandBoxManagerSwift' => ['JKSandBoxManagerSwift/Assets/*.png']
  # }
